    ...
    public class StorageModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            if (_environment.IsDevelopment())
            {
                ...
                connectionString = "AccountEndpoint=https://localhost:8081/;AccountKey=\"C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5Qj4=\";";
                databaseId = "LocalEmulatorDb";
                containerId = "LocalEmulatorContainer";
            }
            else
            {
