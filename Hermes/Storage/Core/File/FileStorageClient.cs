...
{
    /// <summary>
    /// File-based implementation of IStorageClient for simple file-backed persistence using FileDocument.
    ...
    public class FileStorageClient : IStorageClient<FileDocument, string>
    {
        ...
        public FileStorageClient(string rootPath)
        {
            ...
            {
                throw new StorageException("Root path for FileStorageClient cannot be null or empty.", StorageExceptionTypes.ErrorCode.InvalidInput);
            }
